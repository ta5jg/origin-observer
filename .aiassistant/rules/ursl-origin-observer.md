...
These instructions are generated for **JetBrains AI Assistant** from the canonical URSL library. Profile: `origin-observer`. Preserve user-authored project instructions outside the URSL-managed block. Do not claim a check, benchmark, review, or deployment succeeded unless its evidence is available.
