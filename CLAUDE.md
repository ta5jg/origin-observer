<!-- URSL:BEGIN profile=origin-observer target=claude -->

# URSL Project Instructions

These instructions are generated for **Claude Code** from the canonical URSL library. Profile: `origin-observer`. Preserve user-authored project instructions outside the URSL-managed block. Do not claim a check, benchmark, review, or deployment succeeded unless its evidence is available.
...
<!-- URSL:END profile=origin-observer target=claude -->
